...
M.defaults = {
  ...
  keymaps = {
    ...
    file_panel = {
      ...
      { "n", "<leader>e",      actions.focus_files,                    { desc = "Bring focus to the file panel" } },
      { "n", "<leader>b",      actions.toggle_files,                   { desc = "Toggle the file panel" } },
      { "n", "<leader>r",      actions.toggle_reviewed,                { desc = "Toggle the reviewed state of the entry under the cursor" } },
      { "n", "<leader>R",      actions.toggle_show_reviewed,           { desc = "Toggle visibility of the entries marked as reviewed" } },
